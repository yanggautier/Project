...
struct MapPointView: UIViewRepresentable {
...
//    @Binding var showingPlaceDetails: Bool
    ...
    func updateUIView(_ uiView: MKMapView, context: UIViewRepresentableContext<MapPointView>) {
    ...
    class Coordinator: NSObject, MKMapViewDelegate {
        var parent: MapPointView
        
        init(_ parent: MapPointView) {
            self.parent = parent
        }
...
struct MapPointView_Previews: PreviewProvider {
